-- =============================================
-- Las Letras de MaJu — Seed de Posts
-- Correr DESPUÉS de supabase_setup.sql
-- =============================================

INSERT INTO public.posts (titulo, fecha_publicacion, extracto, url, contenido) VALUES

(
  'Mi primer día de trabajo',
  '2020-02-01',
  'El despertador sonó a las 6:00 a.m. Me dolía la cabeza, estaba mareada y era mi primer día de trabajo.',
  'https://lasletrasdemaju.blogspot.com/2020/02/mi-primer-dia-de-trabajo.html',
  'El despertador sonó a las 6:00 a.m. Me dolía la cabeza, estaba mareada y era mi primer día de trabajo. Escuchaba a mi mamá pelear en el fondo. La luz me molestaba horrible y no recordaba mucho. Me levanté, no podía vomitar aunque quería, tenía mucho sueño y un tufo terrible.
...
(
  'Y esta vez es muy es muy personal...',
  '2025-03-01',
  'Voy a mil siempre tengo energía para todos y para todo, intento hacer mucho a la vez y hacer todo bien...',
  'https://lasletrasdemaju.blogspot.com/2025/03/y-esta-vez-es-muy-es-muy-personal.html',
  'Voy a mil siempre tengo energía para todos y para todo, intento hacer mucho a la vez y hacer todo bien, de pequeña no pude hacer muchas cosas en su mayoría por limitaciones económicas, siempre busqué la forma como esa vez que no pude ser porrista, pero veía entrenar de lejos y aprendía todo, bueno esa soy yo siempre, entonces ahora que estoy grande quiero comerme el mundo y por eso me aplaudo y me celebro todo, es un pequeño gesto de amor propio con la niña que un día fui, aparte me autonombre superhéroe así que he sido la mía y la de los míos, cosa supremamente agotadora y lo digo con el mayor amor del mundo.
...
(
  'Gracias Kary por ese espejo',
  '2025-04-01',
  'Hoy recordé que hace unos meses estaba hablando con mi amiga Karina, antes de que viajara a visitarnos a Colombia.',
  'https://lasletrasdemaju.blogspot.com/2025/04/gracias-kary-por-ese-espejo.html',
  'Hoy recordé que hace unos meses estaba hablando con mi amiga Karina, antes de que viajara a visitarnos a Colombia. Nos dimos ese tiempo que a veces parece escaso, pero que cuando llega se vuelve eterno: hablamos de todo, de lo cotidiano, de lo que sentimos, de lo que nos cuesta, de lo que soñamos en voz bajita o de lo que ya gritamos sin miedo.
...
(
  ...
  '2025-06-01',
  'Me gusta el caos, lo dijo esa Maye, que después de un día duro, estresante, por fin se sentó en calma...',
  'https://lasletrasdemaju.blogspot.com/2025/06/caos-el-arte-de-arder-sin-quemarme.html',
  'Me gusta el caos, lo dijo esa Maye, que después de un día duro, estresante, de esos que te sacuden por dentro, por fin se sentó en calma, respiró profundo y se sintió orgullosa de haber sacado adelante una jornada que la superaba.
...
(
  'La editorial soy yo, y el libro está abierto',
  '2025-06-10',
  'Hola, soy Maye… y sí, soy un libro abierto. Siempre lo he sido y, sinceramente, no tengo planes de cerrarme.',
  'https://lasletrasdemaju.blogspot.com/2025/06/la-editorial-soy-yo-y-el-libro-esta.html',
  'Hola, soy Maye… y sí, soy un libro abierto. Siempre lo he sido y, sinceramente, no tengo planes de cerrarme.
...
(
  'No todo vuelve, pero todo enseña',
  '2025-06-20',
  'No todos devuelven lo que damos. Me han atropellado varias veces, personas de las que esperaba un poco más…',
  'https://lasletrasdemaju.blogspot.com/2025/06/no-todo-vuelve-pero-todo-ensena.html',
  'Esta es mi queja de hoy:
...
(
  'Nunca recibí rosas',
  '2025-07-01',
  'Con lo que me gustan las rosas... Y solo las recibo en fechas obligatorias o por cortesía.',
  'https://lasletrasdemaju.blogspot.com/2025/07/nunca-recibi-rosas.html',
  'Con lo que me gustan las rosas...
...
(
  'Entre villanos y mariposas',
  '2025-09-01',
  'Siempre sentí una extraña fascinación por los chicos imposibles. Esos que parecen de todos, pero cuando te miran... son solo tuyos.',
  'https://lasletrasdemaju.blogspot.com/2025/09/entre-villanos-y-mariposas.html',
  'Siempre sentí una extraña fascinación por los chicos imposibles. Esos que parecen de todos, pero cuando te miran... son solo tuyos. Libres, rebeldes, intensos. El tipo de amor que no se puede domar, pero que por un instante te elige y te hace sentir la única en el universo.
...
(
  'Necesité',
  '2025-10-01',
  'Necesidad... Hice muchas cosas en mi vida por necesidad, me tragué el orgullo.',
  'https://lasletrasdemaju.blogspot.com/2025/10/necesite.html',
  'Necesidad... Hice muchas cosas en mi vida por necesidad, me tragué el orgullo. Me sometí a trabajos que me rompían el cuerpo y a relaciones que me deshacían el alma. A humillaciones disfrazadas de oportunidades. A silencios que eran gritos atragantados.
